...
{
  if (Val) {
    setReg8Bits(PTBD, 0x02);           /* PTBD1=0x01 */
    Shadow_PTB |= (byte)0x02;          /* Set-up shadow variable */
  } else { /* !Val */
    clrReg8Bits(PTBD, 0x02);           /* PTBD1=0x00 */
    Shadow_PTB &= (byte)~0x02;         /* Set-up shadow variable */
  } /* !Val */
}
...
{
  if (Dir) {
    setReg8(PTBD, (getReg8(PTBD) & (~0x02)) | (Shadow_PTB & 0x02)); /* PTBD1=Shadow_PTB[bit 1] */
    setReg8Bits(PTBDD, 0x02);          /* PTBDD1=0x01 */
  } else { /* !Dir */
    clrReg8Bits(PTBDD, 0x02);          /* PTBDD1=0x00 */
  } /* !Dir */
}
